                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Edit Division</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{ route('update.shipping', $edit_shipping->id) }}" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{ $edit_shipping->id}}">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="division_name" class="form-control" id="division_name"
                                        value="{{ $edit_shipping->division_name }}">
                                    @error('division_name')
