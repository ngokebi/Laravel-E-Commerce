                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Edit Area</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{ route('update.area', $edit_area->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="controls">
                                        <select name="division_id" class="form-control">
                                            ...
                                            <option value="{{ $div->id }}"
                                                {{ $div->id == $edit_area->division_id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="controls">
                                        <select name="state_id" class="form-control">
                                            ...
                                            <option value="{{ $dis->id }}" {{ $dis->id == $edit_area->state_id ? 'selected': '' }}>{{ $dis->state_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('state_id')
                                            <span class="text-danger"> {{ $message }} </span>
