...
@section('admin')
    ...
    <div class="container-full">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Edit Products</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <form method="post" action="{{ route('update.products') }}">
                                                        ...
                                                        <select name="brand_id" class="form-control">
                                                            ...
                                                            @foreach ($brands as $brand)
                                                                <option value="{{ $brand->id }}"
                                                                    {{ $brand->id == $edit_product->brand_id ? 'selected' : '' }}>
                                                        ...
                                                        <select name="category_id" class="form-control">
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                    {{ $category->id == $edit_product->category_id ? 'selected' : '' }}>
                                                        ...
                                                        <select name="subcategory_id" class="form-control">
                                                            ...
                                                            @foreach ($subcategory as $subcat)
                                                                <option value="{{ $subcat->id }}"
                                                                    {{ $subcat->id == $edit_product->subcategory_id ? 'selected' : '' }}>
                                                        ...
                                                        <select name="subsubcategory_id" class="form-control">
                                                            ...
                                                            @foreach ($subsubcategory as $subsubcat)
                                                                <option value="{{ $subsubcat->id }}"
                                                                    {{ $subsubcat->id == $edit_product->subsubcategory_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_code" class="form-control"
                                                            value="{{ $edit_product->product_code }}">
                                                        @error('product_code')
                                                            <span class="text-danger"> {{ $message }} </span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags" class="form-control"
                                                            value="{{ $edit_product->product_tags }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="discount_price" class="form-control"
                                                            value="{{ $edit_product->discount_price }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size" class="form-control"
                                                            value="{{ $edit_product->product_size }}"
                                                            data-role="tagsinput">
                                                        @error('product_size')
                                                            <span class="text-danger"> {{ $message }} </span>
                                                        @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color" class="form-control"
                                                            value="{{ $edit_product->product_color }}"
                                                            data-role="tagsinput" required="">
                                                        @error('product_color')
                                                            <span class="text-danger"> {{ $message }} </span>
                                                        @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="selling_price" class="form-control"
                                                            value="{{ $edit_product->selling_price }}">
                                                        @error('selling_price')
                                                            <span class="text-danger"> {{ $message }} </span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="short_descriptioshort_descriptionn"
                                                        ...
                                                        Description:</label>
                                                    <div class="controls">
                                                        <textarea cols="50" name="short_description" id="textarea" class="form-control">{{ $edit_product->short_description }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea cols="50" name="long_description" id="textarea" class="form-control">{{ $edit_product->long_description }}</textarea>
                                ...
                                <div class="text-xs-right">
                                    ...
                                    <button type="submit" class="btn btn-rounded btn-outline btn-dark"
                                        style="float: right; margin-left:1%;">Update
                                        Product</button>
        ...
        {{-- Mulitiple Image Update Section --}}

        <section class="content">
            <div class="row">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Products Images</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form action="{{ route('update.product.image') }}" enctype="multipart/form-data"
                                    method="POST">
                                    @csrf
                                        ...
                                        @foreach ($multiImg as $img)
                                            <div class="col-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="photo_image" class="form-label">Change
                                                                Image:</label>
                                                            <div class="controls">
                                                                <input type="file"
                                                                    name="photo_image[{{ $img->id }}]"
                                                                    class="form-control" id="multiImg">
                                                                @error('photo_image')
                                                                    <span class="text-danger"> {{ $message }} </span>
                                                                @enderror
                                                            </div>
                                                        </div>
                                                        <a href="{{route('product.delete.images', $img->id)}}"
                                                            class="btn btn-rounded btn-outline btn-danger" id="deleted">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
        ...
        {{-- Main Thumbnail Update Section --}}

        <section class="content">
            <div class="row">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Products Main Thumbnail</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form action="{{ route('update.product.main_image') }}" enctype="multipart/form-data"
                                    method="POST">
                                    @csrf
                                    <div class="row row-sm">
                                        <input type="hidden" name="id" value="{{ $edit_product->id }}">
                                        <input type="hidden" name="old_img" value="{{$edit_product->product_thumbnail}}">
                                        <div class="col-md-3">
                                            <div class="card">
                                                <img src="{{ asset($edit_product->product_thumbnail) }}"
                                                    class="card-img-top" height="430px" width="280px">
                                                <div class="card-body">
                                                    <div class="form-group">
                                    ...
                                    <div class="text-xs-right">
                                        ...
                                        <button type="submit" class="btn btn-rounded btn-outline btn-dark"
                                            style="float: left;">Update Main Image</button>
                                    </div>
                                </form>
                            </div>
                        </div>
